...
function calcDPS(weaponName, weaponVersion, weaponLevel, weapon, weaponLevel, rarity_dmg_mult, weaponMods) {
    ...
    // let base_movement = weapon[""];
    // let base_accuracy = weapon[""]
    let dotPerSecond = dot / dot_duration;
    ...
    let html_table_component = getDPSZAR(weaponName, weaponVersion, weaponLevel, damage, rps, uptime, reloadTime, avgCritDmgBoost, dotPerSecond, is_multi_pellet, pelletCount, range, pierce, hda_mult);
...
function getDPSZAR(weaponName, weaponVersion, weaponLevel, damage, rps, uptime, reloadTime, avgCritDmgBoost, dotPerSecond, is_multi_pellet, pelletCount, range, pierce, hda_mult) {
    // console.log(weaponName, weaponVersion, weaponLevel, damage, rps, uptime, reloadTime, avgCritDmgBoost, dotPerSecond, is_multi_pellet, pelletCount, range, pierce, hda_mult);
